...
const DB_CREATION_SQLS = require(`${API_CONSTANTS.DB_DIR}/schema.json`);
const DB_PATH = 'C:/Users/HP/OneDrive/Desktop/My_Project/monkshu/backend/apps/sample/db/database.db';
...
async function _createDB() {
    try {
        ...
        try{await mkdirAsync(API_CONSTANTS.DB_DIR)} catch(err){if (err.code != "EEXIST") {LOG.error(`Error creating DB dir, ${err}`); return false;}}   
